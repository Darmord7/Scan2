...
<div class="qodef-wishlist qodef-m">
	<a class="qodef-m-link <?php echo esc_attr( $wishlist_class ); ?>" href="#" data-id="<?php the_ID(); ?>">
		<?php echo qode_framework_icons()->render_icon( 'lnr-bookmark', 'linear-icons' ); ?>
		<?php if ( $enable_title ) {
			$wishlist_title       = esc_html__( 'Bookmark', 'easymeals-core' );
			$wishlist_added_title = esc_html__( 'Bookmarked', 'easymeals-core' );
			?>
