...
if ( ! function_exists( 'easymeals_core_add_ionicons_to_collection' ) ) {
	function easymeals_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'EasyMealsCoreIonIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'easymeals_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EasyMealsCoreIonIconsPack extends QodeFrameworkIconPack {
