...
if ( ! function_exists( 'easymeals_core_add_font_awesome_to_collection' ) ) {
	function easymeals_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'EasyMealsCoreFontAwesomePack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'easymeals_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EasyMealsCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return EASYMEALS_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
