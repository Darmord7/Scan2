...
class EasyMealsCoreTopArea {
	...
	public function __construct() {
		...
		add_action( 'easymeals_action_before_page_header', array( $this, 'load_template' ) );
		...
		add_filter( 'easymeals_filter_add_inline_style', array( $this, 'set_inline_top_area_styles' ) );
	}
	...
	function is_top_area_enabled() {
		$top_area_enabled = easymeals_core_get_post_value_through_levels( 'qodef_top_area_header' ) === 'yes';
    ...
    function is_top_area_in_grid() {
        $top_area_in_grid = easymeals_core_get_post_value_through_levels( 'qodef_top_area_in_grid' ) === 'yes';
	...
	public function set_top_area_height() {
		if ( $this->is_top_area_enabled ) {
			$height         = easymeals_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
	...
	public function is_top_area_transparent() {
		$background_color = easymeals_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
	...
	public function set_variables() {
		$header_object = EasyMealsCoreHeaders::get_instance()->get_header_object();
	...
	public function load_template() {
		$parameters = array(
			...
			'in_grid' => $this->is_top_area_in_grid,
		);
		
		easymeals_core_template_part( 'header/top-area/', 'templates/top-area', '', $parameters );
	}
	...
	public function set_inline_top_area_styles( $style ) {
		...
		$background_color = easymeals_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
		$height           = easymeals_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
		$padding          = easymeals_core_get_post_value_through_levels( 'qodef_top_area_header_side_padding' );
...
EasyMealsCoreTopArea::get_instance();