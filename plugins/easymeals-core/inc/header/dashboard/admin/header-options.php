...
if ( ! function_exists( 'easymeals_core_add_header_options' ) ) {
	/**
	 * Function that add header options for this module
	 */
	function easymeals_core_add_header_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'header',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Header', 'easymeals-core' ),
				'description' => esc_html__( 'Global Header Options', 'easymeals-core' )
			)
		);
		...
		if ( $page ) {
			...
			$general_tab->add_field_element(
				array(
					...
					'options'       => apply_filters( 'easymeals_core_filter_header_layout_option', $header_layout_options = array() ),
			...
			do_action( 'easymeals_core_action_after_header_options_map', $page, $general_tab );
		}
	}

	add_action( 'easymeals_core_action_default_options_init', 'easymeals_core_add_header_options', easymeals_core_get_admin_options_map_position( 'header' ) );
}