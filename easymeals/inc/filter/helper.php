...
if ( ! function_exists( 'easymeals_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function easymeals_get_filter_items( $params ) {
		...
		return apply_filters( 'easymeals_filter_get_filter_items', $items, $params );
	}
}