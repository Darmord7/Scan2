...
if ( ! class_exists( 'EasymealsRestAPI' ) ) {
	/**
	 * Rest API class with configuration
	 */
	class EasymealsRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'easymeals_filter_localize_main_js', array( $this, 'localize_script' ) );
		...
		function localize_script( $global ) {
			...
			return apply_filters( 'easymeals_filter_rest_api_global_variables', $global, $this->get_namespace() );
		}

		function register_rest_api_route() {
			$routes = apply_filters( 'easymeals_filter_rest_api_routes', array() );
