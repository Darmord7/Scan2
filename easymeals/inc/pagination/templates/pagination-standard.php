		...
		<div class="qodef-m-pagination-inner">
			<nav class="qodef-m-pagination-items" role="navigation">
				<div class="qodef-m-pagination-item qodef--prev">
					<a href="#" data-paged="1">
						<?php easymeals_render_icon( 'lnr-chevron-left', 'linear-icons', '' ); ?>
                        <span class="qodef-m-pagination-label"><?php esc_html_e("newer posts", "easymeals");?></span>
					</a>
				</div>
				...
				<div class="qodef-m-pagination-item qodef--next">
					<a href="#" data-paged="2">
                        <span class="qodef-m-pagination-label"><?php esc_html_e("older posts", "easymeals");?></span>
						<?php easymeals_render_icon( 'lnr-chevron-right', 'linear-icons', '' ); ?>
					</a>
				</div>
			</nav>
		</div>
